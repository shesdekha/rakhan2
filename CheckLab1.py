...
class lab0a(unittest.TestCase):
    ...
    def test_c(self):
        ...
        expected = "c7-"+ os.getlogin()
        error_output = 'hostname must be set to c7-[student_id]'
        self.assertEqual(hostname, expected, msg=error_output)
...
class lab0b(unittest.TestCase):
    ...
    def test_a(self):
        ...
        packages = ['python3', 'python', 'screen', 'tmux', 'vim-common', 'vim-enhanced', 'python2-pip', 'python3-pip', 'python-ipython'] 
        installedpackages = []
